...
import com.example.rabotilnica.databinding.FragmentLandBinding;
...
//                                    new Intent(requireContext(), DriverActivity.class) :
//                                    new Intent(requireContext(), MainActivity2.class);
